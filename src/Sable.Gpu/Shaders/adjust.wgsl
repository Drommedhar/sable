...
//   kind 1 Levels:             p0=inBlack, p1=inWhite, p2=gamma
...
fn main(@builtin(global_invocation_id) gid: vec3<u32>) {
    ...
    switch adj.kind {
        case 1u: {  // Levels
            rgb = vec3<f32>(levels1(rgb.x, adj.p0, adj.p1, adj.p2),
                            levels1(rgb.y, adj.p0, adj.p1, adj.p2),
                            levels1(rgb.z, adj.p0, adj.p1, adj.p2));
        }
        case 2u: {  // HSL
            var hsl = rgb2hsl(rgb);
            hsl.x = hsl.x + adj.p0;
